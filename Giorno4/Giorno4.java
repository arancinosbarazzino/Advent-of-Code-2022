...
public class Giorno4 {
  ...
  public static int PrimaParte() throws FileNotFoundException {
    ...
    while (input.hasNextLine()) {
      ...
      if (
        (Integer.parseInt(primo[0]) - Integer.parseInt(secondo[0])) *
        (Integer.parseInt(secondo[1]) - Integer.parseInt(primo[1])) >=
        0
      ) {
        totale += 1;
      } else if (
        (Integer.parseInt(secondo[0]) - Integer.parseInt(primo[0])) *
        (Integer.parseInt(primo[1]) - Integer.parseInt(secondo[1])) >=
        0
      ) {
        totale += 1;
      }
  ...
  public static int SecondaParte() throws FileNotFoundException {
    ...
    while (input.hasNextLine()) {
      ...
      secondo = array[1].split("-");
      if (
        Integer.parseInt(primo[0]) <= Integer.parseInt(secondo[1]) &&
